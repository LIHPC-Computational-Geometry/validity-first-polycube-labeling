...
#include "CustomMeshHalfedges.h"    // CustomMeshHalfedges
...
public:
    ...
    HalfedgesTest() : testing::Test(), mesh_halfedges(cube) {
    }; // link the halfedges API to the cube mesh
...
protected:
    void SetUp() override {
        ...
        //
        // 0-------2    0  0-------2  
        // |       |    | \  \  f1 |  f0 = vertices 0,1,3
        // | front | => |   \  \   |
        // |       |    | f0  \  \ |  f1 = vertices 0,3,2
        // 1-------3    1-------3  3
        //
        // 4-------0    4  4-------0  
        // |       |    | \  \  f3 |  f2 = vertices 1,4,5
        // | left  | => |   \  \   |
        // |       |    | f2  \  \ |  f3 = vertices 0,4,1
        // 5-------1    5-------1  1
        //
        // 6-------4    6  6-------4  
        // |       |    | \  \  f5 |  f4 = vertices 5,6,7
        // | back  | => |   \  \   |
        // |       |    | f4  \  \ |  f5 = vertices 4,6,5
        // 7-------5    7-------5  5
        //
        // 2-------6    2  2-------6  
        // |       |    | \  \  f7 |  f6 = vertices 2,3,7
        // | right | => |   \  \   |
        // |       |    | f6  \  \ |  f7 = vertices 2,7,6
        // 3-------7    3-------7  7
        //
        // 4-------6    4  4-------6  
        // |       |    | \  \  f9 |  f8 = vertices 0,2,4
        // |  top  | => |   \  \   |
        // |       |    | f8  \  \ |  f9 = vertices 2,6,4
        // 0-------2    0-------2  2
        //
        // 1-------3    1  1-------3  
        // |       |    | \  \  f11|  f10 = vertices 1,5,7
        // |bottom | => |   \  \   |
        // |       |    |f10  \  \ |  f11 = vertices 1,7,3
        // 5-------7    5-------7  7
        //
    ...
    MeshHalfedges::Halfedge init_halfedge; // TODO initialize in SetUp()
};
