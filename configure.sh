...
if [ ! -f ext/geogram/CMakeOptions.txt.graphite ]; then
...
SYNOPSIS
    Prepares the build environment for automatic_polycube.
...
echo
echo ============== automatic_polycube build configured ==================
echo

cat << EOF
To build automatic_polycube:
