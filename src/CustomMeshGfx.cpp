...
using namespace GEO;
    ...
    bool CustomMeshGfx::can_use_array_mode(GLUPprimitive prim) const {
        if(do_animation_) {
            return false;
        }
    ...
    void CustomMeshGfx::draw_vertices_immediate_plain() {
        draw_sequences(
            mesh_->vertices,
    ...
    void CustomMeshGfx::draw_vertices_immediate_attrib() {
        begin_attributes();
        draw_sequences(
            mesh_->vertices,
            [&](index_t begin_v, index_t end_v) {
    ...
    void CustomMeshGfx::draw_vertices_array() {
    ...
    void CustomMeshGfx::draw_vertices_selection() {
    ...
    void CustomMeshGfx::draw_vertices() {
        if(mesh_ == nullptr) {
            return;
        }
    ...
    void CustomMeshGfx::draw_edges_array() {
    ...
    void CustomMeshGfx::draw_edges_immediate_plain() {
    ...
    void CustomMeshGfx::draw_edges_immediate_attrib() {
        begin_attributes();
        if(attribute_subelements_ == MESH_VERTICES) {
            glupBegin(GLUP_LINES);
            for(index_t e: mesh_->edges) {
    ...
    void CustomMeshGfx::draw_triangles_array() {
    ...
    void CustomMeshGfx::draw_triangles_immediate_plain() {
    ...
    void CustomMeshGfx::draw_triangles_immediate_attrib() {
        begin_attributes();
        draw_sequences(
            mesh_->facets,
            [&](index_t begin_f, index_t end_f) {
    ...
    void CustomMeshGfx::draw_quads_array() {
        glupBindVertexArray(facets_VAO_);
        if(attribute_subelements_ == MESH_VERTICES) {
            begin_attributes();
        }
    ...
    void CustomMeshGfx::draw_quads_immediate_plain() {
        draw_sequences(
            mesh_->facets,
            [&](index_t begin_f, index_t end_f) {
    ...
    void CustomMeshGfx::draw_quads_immediate_attrib() {
        begin_attributes();
        draw_sequences(
            mesh_->facets,
            [&](index_t begin_f, index_t end_f) {
    ...
    void CustomMeshGfx::draw_triangles_and_quads() {
    ...
    void CustomMeshGfx::draw_triangles_and_quads_array() {
    ...
    void CustomMeshGfx::draw_triangles_and_quads_immediate_plain() {
    ...
    void CustomMeshGfx::draw_triangles_and_quads_immediate_attrib() {
        begin_attributes();
    ...
    void CustomMeshGfx::draw_polygons() {
        if(
            picking_mode_ == MESH_NONE && (
                attribute_subelements_ == MESH_VERTICES ||
                attribute_subelements_ == MESH_FACETS   ||
    ...
    void CustomMeshGfx::draw_polygons_plain() {
    ...
    void CustomMeshGfx::draw_polygons_attrib() {
        begin_attributes();
        facets_filter_.begin(mesh_->facets.attributes(),false);
        glupDisable(GLUP_DRAW_MESH);
        glupBegin(GLUP_TRIANGLES);
    ...
    void CustomMeshGfx::draw_surface() {
        if(mesh_ == nullptr) {
            return;
        }
        set_GLUP_parameters();
    ...
    void CustomMeshGfx::draw_surface_mesh_with_lines() {
        facets_filter_.begin(mesh_->facets.attributes(),false);
        glupSetMeshWidth(GLUPint(mesh_width_));        
    ...
    void CustomMeshGfx::draw_surface_borders() {
        if(picking_mode_ != MESH_NONE) {
            return;
        }
        facets_filter_.begin(mesh_->facets.attributes(),false);
    ...
    void CustomMeshGfx::draw_tets_array() {
    ...
    void CustomMeshGfx::draw_tets_immediate_plain() {
    ...
    void CustomMeshGfx::draw_tets_immediate_attrib() {
        begin_attributes();
        draw_sequences(
            mesh_->cells,
            [&](index_t begin_t, index_t end_t) {
    ...
    void CustomMeshGfx::draw_hybrid() {
        if(
          cells_VAO_ != 0 &&
    ...
    void CustomMeshGfx::draw_hybrid_array() {
    ...
    void CustomMeshGfx::draw_hybrid_immediate_plain() {
        for(index_t type=MESH_TET; type < MESH_NB_CELL_TYPES; ++type) {
            if(!draw_cells_[type] || !has_cells_[type]) {
                continue;
            }
    ...
    void CustomMeshGfx::draw_hybrid_immediate_attrib() {
        begin_attributes();
        for(index_t type=MESH_TET; type < MESH_NB_CELL_TYPES; ++type) {
            if(!draw_cells_[type] || !has_cells_[type]) {
                continue;
    ...
    void CustomMeshGfx::draw_volume() {
        if(mesh_ == nullptr) {
            return;
        }
        if(mesh_->cells.nb() == 0) {
    ...
    void CustomMeshGfx::set_GLUP_picking(MeshElementsFlags what) {
    ...
    void CustomMeshGfx::set_GLUP_vertex_color_from_picking_id(index_t id) {
    ...
    void CustomMeshGfx::bind_vertices_VBO() {
    ...
    void CustomMeshGfx::update_buffer_objects_if_needed() {
    ...
    void CustomMeshGfx::set_scalar_attribute(
    ...
    void CustomMeshGfx::set_texturing(
	MeshElementsFlags subelements,
	const std::string& name,
	GLuint texture,
	index_t texture_dim,
    ...
    void CustomMeshGfx::update_attribute_buffer_objects_if_needed() {
        if(mesh_->vertices.nb() == 0) {
            return;
        }
    ...
    void CustomMeshGfx::bind_attribute_buffer_object(GLuint VAO) {
        if(VAO == 0) {
            return;
        }
        size_t element_size =
    ...
    void CustomMeshGfx::unbind_attribute_buffer_object(GLuint VAO) {
        if(VAO == 0) {
            return;
        }
        glupBindVertexArray(VAO);
    ...
    void CustomMeshGfx::begin_attributes() {
        if(picking_mode_ != MESH_NONE) {
            return;
        }
        if(attribute_subelements_ == MESH_NONE) {
    ...
    void CustomMeshGfx::end_attributes() {
        if(scalar_attribute_.is_bound()) {
    ...
    void CustomMeshGfx::unset_filters() {
        set_filter(MESH_ALL_ELEMENTS,"");
    }

    bool CustomMeshGfx::hw_filtering_supported() const {
    ...
    void CustomMeshGfx::Filter::deallocate() {
        if(VBO != 0) {
    ...
    bool CustomMeshGfx::Filter::begin(
